...
from blesuite.cli.blesuite_wrapper import ble_service_read, ble_service_read_async, ble_service_write, ble_handle_subscribe, ble_service_scan, ble_service_write_async, ble_run_smart_scan
...
def parse_command():
    ...
    parser.add_argument('--async', action='store_true', dest='async_', help='\033[1m<read, write>\033[0m '
                                                             'Enable asynchronous writing/reading. Any output'
                                                             'will be displayed when received. This prevents'
                                                             'blocking.') #async is a reserved word in py3
